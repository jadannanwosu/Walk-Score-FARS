...
```{r}
# Selecting common pedestrian situations. Chose "walking in the road against traffic" but not "with traffic" due to the former usually being the legal protocol when there are no sidewalks. Refer to https://crashstats.nhtsa.dot.gov/Api/Public/ViewPublication/813556 for PEDCTYPE code meanings.
